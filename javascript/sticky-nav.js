...
(function () {
  ...
  if (nav !== null) {
    ...
    var initialPosition = document.querySelector('header').getBoundingClientRect().bottom || scrollContent.offsetTop;
    var finalPosition = document.querySelector('footer').getBoundingClientRect().top || scrollContent.offsetHeight;
